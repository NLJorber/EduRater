...
export default function AboutPage() {
 ...
 <blockquote className="border-l-4 border-brand-orange dark:border-brand-orange pl-16 italic text-brand-blue/80 dark:text-brand-cream/80  my-12">
      ...
      <blockquote className="border-l-4 border-brand-orange pl-16 italic text-brand-blue/80 dark:text-brand-cream/80  my-12">
